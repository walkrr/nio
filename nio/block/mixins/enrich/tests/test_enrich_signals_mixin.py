...
class TestEnrichSignals(NIOBlockTestCase):
    ...
    def test_notified(self):
        ...
        self.assertEqual(self.notified_signals[DEFAULT_TERMINAL][0].num, 1)
        self.assertEqual(self.notified_signals[DEFAULT_TERMINAL][1].num, 2)
        self.assertEqual(self.notified_signals[DEFAULT_TERMINAL][2].num, 3)
        self.assertEqual(self.notified_signals[DEFAULT_TERMINAL][3].num, 4)
