...
class ExpressionProperty(StringProperty):
    ...
    def __init__(self, attr_default='', **kwargs):
        self._attr_default = attr_default
        super().__init__(**kwargs)

    def __get__(self, instance, value):
        evaluator = Evaluator(self._values.get(instance, self._default),
                              self._attr_default)
        return self.ExprFunc(evaluator, self._attr_default)
